...
class LoadCachedAccessTokensUseCase extends UseCase<TokensEntity, NoParams> {
  final AuthenticationRepository authenticationRepository;

  LoadCachedAccessTokensUseCase({required this.authenticationRepository});

  @override
  Future<Either<Failure, TokensEntity>> call(NoParams params) async {
    final response = await authenticationRepository.loadCachedAccessTokens();
